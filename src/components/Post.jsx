export const Post = () => {
    return (
        <div className="flex mb-4">
            <img className="w-12 h-12 rounded-full mr-4" src="https://via.placeholder.com/150" alt="User Profile Picture" />
            <div className="flex-1">
                <div className="flex items-center mb-2">
                    <h2 className="text-lg font-bold text-gray-900">John Doe</h2>
                    <span className="text-gray-600 ml-2">3h ago</span>
                </div>
                <p className="text-gray-800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin eleifend consectetur eros, id hendrerit lorem mollis ut. Sed cursus odio id justo tristique bibendum.</p>
